...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'innovation.count', 'project.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('innovation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'innovation',
          header: 'Innovation',
          accessorKey: 'innovation',
          cell: ({ row: { original: record } }: any) => record?._count?.innovation,
        }
      : null,
